...
# Entrenamiento desde cero (scratch) del plano coronal sobre TCIA, para
# pre-entrenar el YOLO que luego se hace fine-tuning con la cohorte hospital.

DATA_YAML = r"C:\Users\diego\Desktop\TFM\Yolo_Train_TCIA\Coronal\data_TCIA_coronal.yaml"
PROJECT_ROOT = r"C:\Users\diego\Desktop\TFM\TCIA_YOLO11s_results"
RUN_NAME = "YOLO11s_scratch_Coronal_TCIA_more_aug"
