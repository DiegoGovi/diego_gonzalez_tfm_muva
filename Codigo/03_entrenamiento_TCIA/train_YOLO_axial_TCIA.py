...
# Entrenamiento desde cero (scratch) del plano axial sobre TCIA, para
# pre-entrenar el YOLO que luego se hace fine-tuning con la cohorte hospital.

DATA_YAML = r"C:\Users\diego\Desktop\TFM\Yolo_Train_TCIA\Axial\data_TCIA_axial.yaml"
PROJECT_ROOT = r"C:\Users\diego\Desktop\TFM\TCIA_YOLO11s_results"
RUN_NAME = "YOLO11s_scratch_Axial_TCIA_more_aug"


def main():
    print("CUDA:", torch.cuda.is_available())
    # liberar memoria antes de cada run
