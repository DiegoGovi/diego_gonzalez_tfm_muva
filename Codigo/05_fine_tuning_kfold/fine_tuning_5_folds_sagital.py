...
# Fine-tuning 5-fold del plano sagital: parte del peso pre-entrenado en TCIA y
...
TCIA_WEIGHTS = rf"{BASE}\TCIA_YOLO11s_results\YOLO11s_scratch_Sagital_TCIA_more_aug_flip\weights\best.pt"
...
def main():
    ...
    for k in range(5):
        ...
        data_yaml = rf"{KFOLD_ROOT}\fold_{k}\Sagital\data_fold{k}_sagital.yaml"
        ...
        model.train(
            ...
            name=f"YOLO11s_finetune_Sagital_fold{k}",
