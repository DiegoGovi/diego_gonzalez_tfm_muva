...
# Fine-tuning 5-fold del plano axial: parte del peso pre-entrenado en TCIA y
...
TCIA_WEIGHTS = rf"{BASE}\TCIA_YOLO11s_results\YOLO11s_scratch_Axial_TCIA_more_aug\weights\best.pt"
...
def main():
    ...
    for k in range(5):
        ...
        data_yaml = rf"{KFOLD_ROOT}\fold_{k}\Axial\data_fold{k}_axial.yaml"
        ...
        model.train(
            ...
            name=f"YOLO11s_finetune_Axial_fold{k}",
